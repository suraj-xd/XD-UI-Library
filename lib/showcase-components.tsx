...
import QuickTooltipActions from "@/components/custom/quick-tooltip-actions/page";
...
export const showcaseComponents: ComponentShowcaseItem[] = [
  {
    ...
    description: "A beautiful glass morphism audio recording interface with waveform visualization",
    component: <GlassAudioRecorder />,
    code: `"use client";
...
export default function GlassAudioRecorder() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="bg-[#f7f7f7] rounded-3xl shadow-2xl px-12 py-6 pt-8 max-w-md w-full">
        {/* Recording Indicator */}
  ...
  {
    id: "motion-grid",
    title: "Motion Grid States",
    description: "New motion grid component to replace traditional loaders",
    component: <MotionGridDemo />,
    code: 
    `
...
export default function MotionGridDemo() {
  ...
  },
  {
    ...
    component: <SuspensedLiquidGlass />,
    code: `
"use client";
...
`,
    link: "https://21st.dev/suraj-xd/quick-tooltip-actions/default",
    dependencies: ["@phosphor-icons/react", "tooltip", "button"],
  },
  {
    id: "ai-prompt",
    title: "ChatGPT Select Content",
    description: "Select, add content from messages and add them to the input.",
...
import { Button } from "@/components/ui/button";
import MotionGridDemo from "@/app/test/page";
